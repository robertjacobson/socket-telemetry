...
def establish_connection():
    global stop_flag, client_socket, connection_count, connection_reset_count, server_unavailable_count
...
def send_heartbeat():
    global stop_flag, message_count, client_socket, connection_reset_count, server_unavailable_count
